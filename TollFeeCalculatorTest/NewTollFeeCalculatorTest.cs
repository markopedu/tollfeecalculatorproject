...
namespace TollFeeCalculatorTest
{
    public class NewTollFeeCalculatorTest: IClassFixture<TollCalculatorProject.TollCalculator>
    {
        ...
        public void TestGetTollFeeMotorBike()
        {
            ...
            Assert.Equal(expected: fee, actual:0);
        }
        ...
        public void TestGetMaxFee()
        {
            ...
            // 13 
            dates.Add(TestHelper.GetDate(6, 5));
            
            // 18
            dates.Add(TestHelper.GetDate(7, 35));
            
            // 8
            dates.Add(TestHelper.GetDate(10, 32));
            
            // 18
            dates.Add(TestHelper.GetDate(16, 15));
            
            // 8
            dates.Add(TestHelper.GetDate(18, 15));
        ...
        public void TestOneFeeUnderOneHour()
        {
            ...
            // 18
            dates.Add(TestHelper.GetDate(7, 5));
